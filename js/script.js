(function($, OC) {
  $(function() {
    ...
    if (window.isSecureContext && window.navigator.registerProtocolHandler) {
      window.navigator.registerProtocolHandler(
        "geo",
        OC.generateUrl("/apps/maps/openGeoLink/") + "%s",
        "Nextcloud Maps"
      );
    }
      ...
      if (event.button === 0) {
        ...
        if (
          !event.target.matches(
            ".app-navigation-entry-utils-menu-button button"
          )
        ) {
    ...
    $("body").on(
      "contextmenu",
      "#navigation-favorites, #navigation-photos, #navigation-devices, #navigation-tracks",
      function(e) {
        var id = $(e.target).attr("id");
        if (
          e.target.tagName === "LI" &&
          (id === "navigation-favorites" ||
            id === "navigation-photos" ||
  ...
  var geoLinkController = {
    ...
    shareLocation: function(e) {
      ...
      OC.Notification.showTemporary(
        t("maps", "Geo link ({geoLink}) copied to clipboard", {
          geoLink: geoLink
        })
      );
    }
    ...
    restoreOptions: function() {
      ...
      $.ajax({
        ...
        .done(function(response) {
          ...
          if (
            optionsValues.hasOwnProperty("installScanDone") &&
            optionsValues.installScanDone === "no"
          ) {
            OC.Notification.showTemporary(
              t(
                "maps",
          ...
          if (
            optionsValues.hasOwnProperty("displaySlider") &&
            optionsValues.displaySlider === "true"
          ) {
            $("#timeRangeSlider").show();
          ...
          if (optionsValues.hasOwnProperty("mapBounds")) {
            ...
            if (nsew.length === 4) {
              ...
              if (n && s && e && w) {
                mapController.map.fitBounds([[n, e], [s, w]]);
              }
            }
          }
          if (
            !optionsValues.hasOwnProperty("photosLayer") ||
            optionsValues.photosLayer === "true"
          ) {
            photosController.toggleLayer();
          }
          if (
            !optionsValues.hasOwnProperty("contactGroupListShow") ||
            optionsValues.contactGroupListShow === "true"
          ) {
            contactsController.toggleGroupList();
          }
          if (
            optionsValues.hasOwnProperty("disabledContactGroups") &&
          ...
          if (
            !optionsValues.hasOwnProperty("contactLayer") ||
            optionsValues.contactLayer === "true"
          ) {
            contactsController.toggleLayer();
          }
          if (
            optionsValues.hasOwnProperty("locControlEnabled") &&
            optionsValues.locControlEnabled === "true"
          ) {
            mapController.locControl.start();
          }
          if (
            !optionsValues.hasOwnProperty("favoriteCategoryListShow") ||
            optionsValues.favoriteCategoryListShow === "true"
          ) {
            favoritesController.toggleCategoryList();
          }
          if (
            optionsValues.hasOwnProperty("enabledFavoriteCategories") &&
          ...
          if (
            !optionsValues.hasOwnProperty("favoritesEnabled") ||
            optionsValues.favoritesEnabled === "true"
          ) {
            favoritesController.toggleFavorites();
          }
          if (
            !optionsValues.hasOwnProperty("trackListShow") ||
            optionsValues.trackListShow === "true"
          ) {
            tracksController.toggleTrackList();
          }
          if (
            optionsValues.hasOwnProperty("enabledTracks") &&
            optionsValues.enabledTracks &&
            optionsValues.enabledTracks !== ""
          ) {
            that.enabledTracks = optionsValues.enabledTracks
              .split("|")
              .map(function(x) {
                return parseInt(x);
              });
          ...
          if (
            optionsValues.hasOwnProperty("tracksSortOrder") &&
            optionsValues.tracksSortOrder !== ""
          ) {
          ...
          if (
            ...
            !optionsValues.hasOwnProperty("tracksEnabled") ||
            optionsValues.tracksEnabled === "true"
          ) {
            tracksController.toggleTracks();
          }
          if (
            !optionsValues.hasOwnProperty("deviceListShow") ||
            optionsValues.deviceListShow === "true"
          ) {
            devicesController.toggleDeviceList();
          }
          if (
            optionsValues.hasOwnProperty("enabledDevices") &&
            optionsValues.enabledDevices &&
            optionsValues.enabledDevices !== ""
          ) {
            that.enabledDevices = optionsValues.enabledDevices
              .split("|")
              .map(function(x) {
                return parseInt(x);
              });
          ...
          if (
            optionsValues.hasOwnProperty("enabledDeviceLines") &&
            optionsValues.enabledDeviceLines &&
            optionsValues.enabledDeviceLines !== ""
          ) {
            that.enabledDeviceLines = optionsValues.enabledDeviceLines
              .split("|")
              .map(function(x) {
                return parseInt(x);
              });
          ...
          if (
            !optionsValues.hasOwnProperty("devicesEnabled") ||
            optionsValues.devicesEnabled === "true"
          ) {
            devicesController.toggleDevices();
          }
          if (
            optionsValues.hasOwnProperty("trackMe") &&
            optionsValues.trackMe === "true"
          ) {
          ...
          mapController.map.on("baselayerchange ", function(e) {
            ...
            if (e.name === "Watercolor") {
              mapController.map.addLayer(
                mapController.baseOverlays["Roads and labels"]
              );
            }
          ...
          that.nbRouters = 0;
          if (
            optionsValues.hasOwnProperty("osrmCarURL") &&
            optionsValues.osrmCarURL !== ""
          ) {
            that.nbRouters++;
          }
          if (
            optionsValues.hasOwnProperty("osrmBikeURL") &&
            optionsValues.osrmBikeURL !== ""
          ) {
            that.nbRouters++;
          }
          if (
            optionsValues.hasOwnProperty("osrmFootURL") &&
            optionsValues.osrmFootURL !== ""
          ) {
            that.nbRouters++;
          }
          if (
            optionsValues.hasOwnProperty("mapboxAPIKEY") &&
            optionsValues.mapboxAPIKEY !== ""
          ) {
            that.nbRouters++;
          }
          if (
            (optionsValues.hasOwnProperty("graphhopperURL") &&
              optionsValues.graphhopperURL !== "") ||
            (optionsValues.hasOwnProperty("graphhopperAPIKEY") &&
              optionsValues.graphhopperAPIKEY !== "")
          ) {
            that.nbRouters++;
          }
          if (that.nbRouters === 0 && !OC.isUserAdmin()) {
            ...
            mapController.map.contextmenu.removeItem(
              mapController.map.contextmenu._items[
                mapController.map.contextmenu._items.length - 1
              ].el
            );
            mapController.map.contextmenu.removeItem(
              mapController.map.contextmenu._items[
            ...
            routingController.initRoutingControl(
              mapController.map,
              optionsValues
            );
          }
  ...
  var mapController = {
    ...
    displaySearchResult: function(results) {
      ...
      for (var i = 0; i < results.length; i++) {
        ...
        searchMarker.bindTooltip(tooltipContent, {
    ...
    initMap: function() {
      ...
      var attributionDark =
        "&copy; Map tiles by CartoDB, under CC BY 3.0. Data by OpenStreetMap, under ODbL.";
      ...
      var starImageUrl = OC.generateUrl(
        "/svg/core/actions/star-dark?color=000000"
      );
      var markerRedImageUrl = OC.generateUrl(
        "/svg/core/actions/address?color=EE3333"
      );
      var markerBlueImageUrl = OC.generateUrl(
        "/svg/core/actions/address?color=3333EE"
      );
      var markerGreenImageUrl = OC.generateUrl(
        "/svg/core/actions/address?color=33EE33"
      );
      var photoImageUrl = OC.generateUrl(
        "/svg/core/places/picture?color=000000"
      );
      var contactImageUrl = OC.generateUrl(
        "/svg/core/actions/user?color=000000"
      );
      var shareImageUrl = OC.generateUrl(
      ...
      $(".leaflet-control-locate a").click(function(e) {
        optionsController.saveOptionValues({
          locControlEnabled: mapController.locControl._active
        });
      });
      ...
      this.controlLayers = L.control
        .layers(this.baseLayers, this.baseOverlays, {
          position: "bottomright",
          collapsed: false
        })
        .addTo(this.map);
  ...
  var routingController = {
    ...
    initRoutingControl: function(map, optionsValues) {
      ...
      L.Routing.Localization[lang] = {
        ...
        instructions: {
          ...
          Head: [t("maps", "Head {dir}"), t("maps", " on {road}")],
      ...
      if (
        optionsValues.hasOwnProperty("osrmDEMO") &&
        optionsValues.osrmDEMO === "1"
      ) {
      ...
      if (
        ...
        this.addRouter(
          ...
          "Mapbox by car with traffic",
          null,
          optionsValues.mapboxAPIKEY
        );
        this.addRouter(
          "mapbox/driving",
          "Mapbox by car without traffic",
          null,
          optionsValues.mapboxAPIKEY
        );
      }
      ...
      if (
        optionsValues.hasOwnProperty("selectedRouter") &&
        optionsValues.selectedRouter !== ""
      ) {
    ...
    addRouter: function(type, name, url, apikey) {
      if (
        type === "graphhopperBike" ||
        type === "graphhopperCar" ||
        type === "graphhopperFoot"
      ) {
        var options = {};
    ...
    onRoutingEnd: function(e) {
      ...
      setTimeout(function() {
        $("#navigation-routing").removeClass("icon-loading-small");
        $(".leaflet-routing-reverse-waypoints").removeClass(
          "icon-loading-small"
        );
      }, 5000);
    },
    ...
    exportRoute: function() {
      if (
        this.control.hasOwnProperty("_selectedRoute") &&
        ...
        $.ajax({
          ...
          .done(function(response) {
            OC.Notification.showTemporary(
              t("maps", "Route exported in {path}", { path: response })
            );
          })
          ...
          .fail(function() {
            OC.Notification.showTemporary(
              t("maps", "Failed to export current route")
            );
          });
      }
    },
  ...
  var timeFilterController = {
    ...
    connect: function() {
      ...
      this.sliderConnect = this.slider.getElementsByClassName(
        "noUi-connect"
      )[0];
      ...
      this.slider.noUiSlider.on("update", function(
        ...
        if (!that.onUpdateCallbackBlock) {
          ...
          if (
            Math.round(unencoded[0]) < Math.round(that.min) ||
      ...
      this.slider.noUiSlider.on("change", function(
        ...
        if (!that.onChangeCallbackBlock) {
          ...
          if (unencoded[0] < that.min) {
            ...
            that.updateSliderRange(
              that.min - (25 * delta * delta) / r,
              that.max
            );
          }
  ...
  var searchController = {
    ...
    initController: function(map) {
      ...
      $("body").on("keyup", ".leaflet-routing-geocoder input", function(e) {
        ...
        // if any other key (except arrows up/down) is pressed => enable autocomplete again
          ...
          $(".leaflet-routing-geocoder-result").removeClass(
      ...
      $("body").on("click", "#click-search-add-favorite", function(e) {
        ...
        var name =
          that.currentClickAddress.attraction ||
        ...
        favoritesController.addFavoriteDB(
          categoryName,
          lat,
          lng,
          name,
    ...
    setSearchAutocomplete: function(field, routingPointIndex = null) {
      ...
      if (field === this.SEARCH_BAR) {
        ...
        fieldElement = $(".leaflet-routing-geocoder input").eq(
          routingPointIndex
        );
      }
      var that = this;
      ...
      fieldElement
            ...
            if (it.type === "favorite") {
              ...
              navigator.geolocation.getCurrentPosition(function(position) {
                ...
                if (field === that.SEARCH_BAR || field === that.ROUTING_TO) {
                  ...
                  routingController.setRoutePoint(
                    routingPointIndex,
                    L.latLng(lat, lng)
                  );
                  $(".leaflet-routing-geocoder input")
        ...
        var listItem = $("<li></li>")
          ...
          .append(
            '<a class="searchCompleteLink"><button class="searchCompleteIcon ' +
              iconClass +
              '">' +
              iconElem +
              "</button> " +
    ...
    submitSearchPOI: function(type, typeName) {
      ...
      this.searchPOI(type, latMin, latMax, lngMin, lngMax).then(function(
        results
      ) {
        if (results.length === 0) {
          OC.Notification.showTemporary(
            t("maps", "No {POItypeName} found", { POItypeName: typeName })
          );
          return;
        }
    ...
    parseOsmResult: function(result) {
      ...
      if (state && add && add.country_code == "us") {
      ...
      if (result.icon) {
        header =
          '<div class="inline-wrapper"><img class="location-icon" src="' +
          result.icon +
          '" />' +
          header +
          "</div>";
      ...
      desc +=
        '<button class="search-add-favorite" lat="' +
        result.lat +
        '" lng="' +
        result.lon +
        '">' +
        ...
        "</button>";
      desc +=
        '<button class="search-place-contact" lat="' +
        result.lat +
        '" lng="' +
        result.lon +
        '">' +
      ...
      if (extras.opening_hours) {
        desc +=
          '<div id="opening-hours-header" class="inline-wrapper"><img class="popup-icon" src="' +
          OC.filePath("maps", "img", "recent.svg") +
          '" />';
        ...
        if (changeDt) {
          ...
          if (isCurrentlyOpen) {
            desc +=
              '<span class="poi-open">' + t("maps", "Open") + "&nbsp;</span>";
            if (dtDiff <= 60) {
              desc +=
                '<span class="poi-closes">,&nbsp;' +
                t("maps", "closes in {nb} minutes", { nb: parseInt(dtDiff) }) +
                "</span>";
            } else {
              desc +=
                "<span>&nbsp;" +
                t("maps", "until {date}", {
                  date: changeDt.toLocaleTimeString()
                }) +
                "</span>";
            }
          } else {
            desc +=
              '<span class="poi-closed">' +
              t("maps", "Closed") +
              "&nbsp;</span>";
            desc +=
              '<span class="poi-opens">' +
              t("maps", "opens at {date}", {
                date: changeDt.toLocaleTimeString()
              }) +
              "</span>";
          }
        ...
        desc +=
          '<img id="opening-hours-table-toggle-collapse" src="' +
      ...
      if (extras.website) {
        desc +=
          '<div class="inline-wrapper"><img class="popup-icon" src="' +
          OC.filePath("maps", "img", "link.svg") +
          '" /><a href="' +
          extras.website +
          '" target="_blank">' +
    ...
    mapLeftClick: function(e) {
      ...
      var clickPopupContent =
        '<h2 id="click-search-popup-title" class="loading">' +
        t("maps", "This place") +
        "</h2>";
      clickPopupContent += '<textarea id="clickSearchAddress"></textarea><br/>';
      clickPopupContent +=
        '<button id="click-search-add-favorite">' +
        '<span class="icon-favorite"> </span> ' +
        t("maps", "Add to favorites") +
        "</button>";
      clickPopupContent +=
        '<button id="click-search-place-contact">' +
        '<span class="icon-user"> </span> ' +
        t("maps", "Add contact address") +
        "</button>";
  ...
  var nonLocalizedPhotosController = new NonLocalizedPhotosController(
    optionsController,
    timeFilterController,
    photosController
  );
